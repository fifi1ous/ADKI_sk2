...
namespace {
struct qt_meta_tag_ZN4DrawE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN4DrawE = QtMocHelpers::stringData(
    "Draw"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN4DrawE[] = {
...
Q_CONSTINIT const QMetaObject Draw::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN4DrawE.offsetsAndSizes,
    qt_meta_data_ZN4DrawE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN4DrawE_t,
        // Q_OBJECT / Q_GADGET
...
void *Draw::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN4DrawE.stringdata0))
